  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-peachCream relative font-poppins">
      ...
      <Image
        ...
        width={400}
        height={400}
        className="hidden md:block absolute md:top-30 left-0 md:left-10 lg:left-110 opacity-90 w-[400px] md:w-[300px]"
      />
      <Image
        ...
        width={250}
        height={250}
        className="hidden md:block absolute md:top-30 right-0 md:right-10 lg:right-110 opacity-90 w-[400px] md:w-[300px]"
      />
      <Image
        ...
        width={250}
        height={250}
        className="hidden md:block absolute bottom-25 left-0 md:left-10 lg:left-110 w-[200px] md:w-[250px] lg:w-[280px]"
      />
      <Image
        ...
        width={250}
        height={250}
        className="hidden md:block absolute bottom-25 right-0 md:right-10 lg:right-110 w-[200px] md:w-[250px] lg:w-[280px]"
      />
      ...
      <div className="bg-darkRed text-white p-10 rounded-2xl shadow-lg w-full max-w-md z-10">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full mb-5 bg-pastelPink text-darkRed font-semibold rounded-md py-2 hover:bg-bgColor hover:text-crimsonRed hover:border-pastelPink transition"
          >
            Sign In
          </button>
        </form>
